...
},{}],"node_modules/notion-api-js/dist/lib/fetch.js":[function(require,module,exports) {
"use strict";
...
},{"node-fetch":"node_modules/node-fetch/browser.js"}],"node_modules/slugify/slugify.js":[function(require,module,exports) {
var define;
...
},{}],"node_modules/notion-api-js/dist/lib/helpers.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{}],"node_modules/notion-api-js/dist/notion.js":[function(require,module,exports) {
...
class Notion {
  constructor({
    ...
    const notionToken = token || undefined;
    if (!notionToken) throw new Error('You need to provide the token to use the API');
    this.creds = {
      token: notionToken
    };
  ...
  getPagesByIndexId(startingPageId) {
    return __awaiter(this, void 0, void 0, function* () {
      return fetch_1.default({
        ...
        return yield Promise.all(entries.map(({
          value
        }) => this.getPageById(value.id)));
      })).catch(e => {
        helpers_1.handleNotionError(e);
        return [];
      });
  ...
  getAllHTML() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        helpers_1.handleNotionError(error);
        return [];
      }
    });
  }
...
var _notionApiJs = _interopRequireDefault(require("notion-api-js"));
...
testa.innerHTML = "<div class=\"ccb\">\n<svg class=\"ccb-outline\" width=\"70\" height=\"70\" viewBox=\"0 0 70 70\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n    <circle cx=\"35\" cy=\"35\" r=\"33.5\" stroke=\"".concat(test_color, "\" stroke-width=\"2\"/>\n    </svg>\n<svg class=\"ccb-fill\" width=\"70\" height=\"70\" viewBox=\"0 0 70 70\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n    <circle cx=\"35\" cy=\"35\" r=\"35\" fill=\"").concat(test_color, "\" />\n    </svg>\n</div>\n<svg class=\"cca\" width=\"10\" height=\"10\" viewBox=\"0 0 10 10\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<circle cx=\"5\" cy=\"5\" r=\"5\" fill=\"").concat(test_color, "\"/>\n</svg>");

if (document.querySelector('.test[hide]')) {
  testa.innerHTML = testa.innerHTML + "<style>body {cursor: none;}</style>";
}

var circleSvg = document.querySelector('.cca');
var circleSvg2 = document.querySelector('.ccb');
var btn = document.querySelector('button'); // 終極跑跑圖片

var c_typogrid_title_images = document.querySelector('.c-typogrid-title-images');
var mouseX = 0;
var mouseY = 0;
var m1x, m2x, m1y, m2y;
mouseX = m1x, m2x;
...
var mouseMove = function mouseMove() {
  // 終極跑跑圖片
  c_typogrid_title_images.style.left = m1x;
...
mouseMove();
document.querySelectorAll('a, img, .img, button').forEach(function (item) {
...
var menu_c = true;
var menu_c_ele = document.querySelector('.c-header_button_click');
menu_c_ele.addEventListener('click', function () {
  if (menu_c == true) {
    document.querySelector('html').classList.remove("menu-open");
    menu_c = false;
    console.log(menu_c);
  } else if (menu_c == false) {
...
//     token: "YOUR_TOKEN_V2"
// });
// const questionEl = document.querySelector('body');
...
},{"locomotive-scroll":"node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","notion-api-js":"node_modules/notion-api-js/dist/notion.js"}],"../Users/oldma/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/typogrid.e31bb0bc.js.map